"""
Django settings for WeeklyProjects project.
...
SECRET_KEY = 'django-insecure-o!-mcrv(mavb6!d%9i24rc6$e5y1nctnd4qj0sodb!cw2%ypmf'
...
ROOT_URLCONF = 'WeeklyProjects.urls'
...
WSGI_APPLICATION = 'WeeklyProjects.wsgi.application'
